...
ActiveRecord::Schema.define(version: 20160730015711) do
  ...
  add_index "rooms", ["email"], name: "index_rooms_on_email", unique: true, using: :btree
  add_index "rooms", ["reset_password_token"], name: "index_rooms_on_reset_password_token", unique: true, using: :btree
